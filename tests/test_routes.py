...
@pytest.mark.parametrize("endpoint", ANONYMOUS_ENDPOINTS)
...
@pytest.mark.django_db
@pytest.mark.parametrize("endpoint", AUTH_USER_ENDPOINTS)
...
@pytest.mark.django_db
@pytest.mark.parametrize("endpoint", LOGIN_REQURE_ENDPOINTS)
